...
# and plot it:
plot(energies_w_diff_k, dpi = 300, lw = 3, xlabel = "k-grid", ylabel = "Energy/Atom", label = "k", xaxis = :log)
scatter!(energies_w_diff_k, label = "Data points")

#md # ```@raw html
#md # <img src="../kgrid.png" width=600 height=400 />
#md # ```
...
#md # ```@raw html
#md # <img src="../ecut.png" width=600 height=400 />
#md # ```